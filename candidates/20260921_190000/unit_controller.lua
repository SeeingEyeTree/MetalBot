-- RUN 20260921_190000 (tune_parameters): concentrate the army. THRUST_FRAC 0.55->0.85 and
-- THRUST_NODE_HALF 5->3, so ~85% of army value stacks on a 7-node window instead of being
-- smeared over the 32-node full-width line (replay: 1.88 dmg ratio but 393 units lost).
...
local THRUST_FRAC        = 0.85  -- concentrate: share of army metal value in the thrust zone (was 0.55)
...
local THRUST_NODE_HALF  = 3    -- thrust window = thrustIdx +- this many nodes (was 5)
